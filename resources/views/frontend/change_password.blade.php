        ...
        <main class="h-screen font-mont flex items-center justify-center text-center min-h-screen">
            <div class="container mx-auto flex justify-center items-center">
                ...
                <form action="{{ route('register') }}" method="POST" class="flex-col text-left align-left justify-left">
                    ...
                    <div class="mt-6">
                    <input type="password" id="password_confirmation" name="password_confirmation" class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-72 rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-1" required placeholder="New Password"/>
                    </div>
                    <div class="mt-10">
                    <p class="text-cream text-center text-sm sm:text-base md:text-lg">
                        <a href="" class="text-[#f0f0f0] underline">Create Admin</a>
                    </p>
                    </div>
