...
<div class="ml-[20%] min-h-screen h-auto bg-green-light">
    <div class="grid grid-rows-[110px_auto] relative">
            ...
            <div class="px-4 py-6 h-full mt-[3rem] flex flex-col gap-2">
                <div class="bg-green-main/20 grid grid-rows-[40px_300px_40px] rounded-md overflow-hidden hover:bg-green-main/30">
                    <div class="flex flex-row gap-8 px-3 items-center py-2 border-b-2 border-black/40">
                        ...
                        <h1 class="text-xs">12 Januari 2025</h1>
                    </div>
                    <div class="grid grid-cols-[40%_60%] gap-2">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div class="flex flex-col px-1 py-2">
                                ...
                                <p class="text-md capitalize font-medium">02-12-2025</p>
                            </div>
                            <div class="flex flex-col px-1 py-2">
                ...
                <div class="bg-green-main/20 grid grid-rows-[40px_300px_40px] rounded-md overflow-hidden hover:bg-green-main/30">
                    <div class="flex flex-row gap-8 px-3 items-center py-2 border-b-2 border-black/40">
                        <h1 class="text-xs font-bold">Souvenir</h1>
                        <h1 class="text-xs">Indah Duniawi</h1>
                        <h1 class="text-xs">12 Januari 2025</h1>
                    </div>
                    <div class="grid grid-cols-[40%_60%] gap-2">
                        <div class="px-3 py-3 overflow-hidden h-auto">
                            <img src="{{ asset('img/souvenirA.jpeg') }}" alt="" class="object-cover w-full h-full rounded-md bg-gray-200">
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="flex flex-col px-1 py-2">
                                <p class="text-sm mb-1">Alamat</p>
                            ...
                            <div class="flex flex-col px-1 py-2">
                                <p class="text-sm mb-1">Status Bayar</p>
                                <p class="text-md capitalize font-medium">Lupa bayar</p>
                            </div>
                            <div class="flex flex-col px-1 py-2">
                                <p class="text-sm mb-1">Status Desain</p>
                                <p class="text-md capitalize font-medium">Menunggu</p>
                ...
                <div class="bg-green-main/20 grid grid-rows-[40px_300px_40px] rounded-md overflow-hidden hover:bg-green-main/30">
                    <div class="flex flex-row gap-8 px-3 items-center py-2 border-b-2 border-black/40">
                        <h1 class="text-xs font-bold">Packaging</h1>
                        <h1 class="text-xs">Indah Duniawi</h1>
                        <h1 class="text-xs">12 Januari 2025</h1>
                    </div>
                    <div class="grid grid-cols-[40%_60%] gap-2">
                        <div class="px-3 py-3 overflow-hidden">
                            <img src="{{ asset('img/packagingB.jpeg') }}" alt="" class="object-cover w-full h-full rounded-md bg-gray-200">
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="flex flex-col px-1 py-2">
                                <p class="text-sm mb-1">Alamat</p>
        ...
        <div class="hidden" id="page-fix">
            <div class="px-4 py-6 h-full mt-[3rem] flex flex-col gap-2">
                <div class="bg-green-main/20 grid grid-rows-[40px_300px_40px] rounded-md overflow-hidden hover:bg-green-main/30">
                    ...
                    <div class="grid grid-cols-[40%_60%] gap-2">
                        <div class="px-3 py-3 overflow-hidden">
                            <img src="{{ asset('img/undanganC.jpeg') }}" alt="" class="object-cover w-full h-full rounded-md bg-gray-200">
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="flex flex-col px-1 py-2">
                                <p class="text-sm mb-1">Alamat</p>
        ...
        <div class="hidden" id="page-order">
            <div class="px-4 py-6 h-full mt-[3rem] flex flex-col gap-2">
                <div class="bg-green-main/20 grid grid-rows-[40px_300px] rounded-md overflow-hidden hover:bg-green-main/30 place-items-center">
                    Belum Ada Pesanan
