...
@section('konten')
<div class="ml-[20%] min-h-screen h-auto bg-blue-100">
    <div class="grid grid-rows-[12%_88%] relative">
        ...
        <!-- konten utama -->
        <div class="mt-[4.25rem]">
            <div class="grid grid-cols-2 gap-5 place-items-center py-5">
                <div class="w-[90%] overflow-hidden">
                    ...
                    <div class="bg-green-main/40 rounded-b-lg rounded-tr-lg h-[400px] grid grid-rows-[58%_20%_15%_7%] overflow-hidden">
                        ...
                        <div class="grid grid-cols-2 gap-1 p-1 place-items-center">
                            <button type="button" data-id="button-order-1" class="button-progres bg-green-main/80 rounded-lg px-2 py-1 w-[120px] text-sm text-white hover:border-2 hover:border-green-main/80 hover:bg-green-main/0 hover:text-green-main/80 transition duration-300 border-white/0 font-medium">Lihat Progres</button>
                        ...
                        <!-- Main modal -->
                        <div id="button-order-1" class="hidden">
                ...
                <div class="w-[90%] overflow-hidden">
                    ...
                    <div class="bg-green-main/40 rounded-b-lg rounded-tr-lg h-[400px] grid grid-rows-[58%_20%_15%_7%] overflow-hidden">
                        ...
                        <!-- button -->
                        <div class="grid grid-cols-2 gap-1 p-1 place-items-center">
                            <button type="button" data-id="button-order-2" class="button-progres bg-green-main/80 rounded-lg px-2 py-1 w-[120px] text-sm text-white hover:border-2 hover:border-green-main/80 hover:bg-green-main/0 hover:text-green-main/80 transition duration-300 border-white/0 font-medium">Lihat Progres</button>
                            <button type="button" class="bg-green-main/80 rounded-lg px-2 py-1 w-[120px] text-sm text-white hover:border-2 hover:border-green-main/80 hover:bg-green-main/0 hover:text-green-main/80 transition duration-300 border-white/0 font-medium">Detail</button>
                        </div>

                        <!-- Main modal -->
                        <div id="button-order-2" class="hidden">
                            <div tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-screen bg-black/50">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <!-- Modal content -->
                                    <div class="relative bg-white/60 backdrop-blur-lg rounded-lg shadow-sm">
                ...
                <div class="w-[90%] overflow-hidden">
                    ...
                    <div class="bg-green-main/40 rounded-b-lg rounded-tr-lg h-[400px] grid grid-rows-[58%_20%_15%_7%] overflow-hidden">
                        ...
                        <!-- button -->
                        <div class="grid grid-cols-2 gap-1 p-1 place-items-center">
                            <button type="button" data-id="button-order-3" class="button-progres bg-green-main/80 rounded-lg px-2 py-1 w-[120px] text-sm text-white hover:border-2 hover:border-green-main/80 hover:bg-green-main/0 hover:text-green-main/80 transition duration-300 border-white/0 font-medium">Lihat Progres</button>
                            <button type="button" class="bg-green-main/80 rounded-lg px-2 py-1 w-[120px] text-sm text-white hover:border-2 hover:border-green-main/80 hover:bg-green-main/0 hover:text-green-main/80 transition duration-300 border-white/0 font-medium">Detail</button>
                        </div>

                        <!-- Main modal -->
                        <div id="button-order-3" class="hidden">
                            <div tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-screen bg-black/50">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <!-- Modal content -->
                                    <div class="relative bg-white/60 backdrop-blur-lg rounded-lg shadow-sm">
...
<script>
    ...
    buttonProgres.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            document.querySelectorAll('[id^="button-order-"]').forEach(div=> {
