  ...
  <aside class="z-40 lg:w-1/5 md:w-[50px] w-[50px] fixed top-0 left-0 h-full lg:min-h-screen bg-green-main">
    <div>
      <ul class="space-y-5 py-10">
        ...
        <li>
          <a href="/user/dashboard" style="letter-spacing: 3px" class="font-sans flex items-center pl-3 pr-1 py-2 w-[45px] lg:py-3 lg:px-4 lg:w-5/6 rounded-r-2xl text-cream hover:bg-cream hover:text-green-main">
        ...
        <li>
          <a href="/user/orders" style="letter-spacing: 3px" class="font-sans flex items-center pl-3 pr-1 py-2 w-[45px] lg:py-3 lg:px-4 lg:w-5/6 rounded-r-2xl text-cream hover:bg-cream hover:text-green-main">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 lg:size-5 lg:mr-2">
        ...
        <li>
          <a href="" style="letter-spacing: 3px" class="font-sans flex items-center pl-3 pr-1 py-2 w-[45px] lg:py-3 lg:px-4 lg:w-5/6 rounded-r-2xl text-cream hover:bg-cream hover:text-green-main">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 lg:size-5 lg:mr-2">
        ...
        <li>
          ...
          @csrf
              <button type="submit" style="letter-spacing: 3px" class="font-sans flex items-center pl-3 pr-1 py-2 w-[45px] lg:py-3 lg:px-4 lg:w-5/6 rounded-r-2xl text-cream hover:bg-cream hover:text-green-main">
