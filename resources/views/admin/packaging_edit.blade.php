        ...
        <div>
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="flex items-center flex-col ">
              ...
              <input type="date" id="fix_design_date" name="fix_design_date" value="{{ $packaging->fix_design_date }}"
            ...
            <div class="flex items-center flex-col">
              ...
              <div class="relative w-80">
                ...
                <input type="text" id="price_per_pcs" name="price_per_pcs"
                    value="{{ number_format($packaging->price_per_pcs, 0, ',', '.') }}"
                ...
                <input type="hidden" id="price_per_pcs_hidden" name="price_per_pcs" value="{{ $packaging->price_per_pcs }}">
              </div>
            </div>
