                    ...
                    <tbody class="bg-green-main/10 overflow-y-auto">
                        ...
                        <tr class="h-16 border-t-[1.5px] border-black/30 hover:bg-green-main/15" data-progress="{{ $o->payment_status }}">
                            ...
                            <td class="px-3 py-3 text-center">
                                <a href="{{ route('admin.souvenir.detail', ['id' => $o->id]) }}" class="bg-brown-enzo rounded-lg px-2 py-2 hover:scale-110 transition duration-300 inline-block text-white">Detail</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
