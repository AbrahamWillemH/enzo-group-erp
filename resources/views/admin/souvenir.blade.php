                    ...
                    <div class="grid grid-cols-7 gap-1 font-medium">
                        ...
                        <div class="flex flex-col justify-center items-center group relative">
                            ...
                            <div id="menu-sort"
                                ...
                                <a href="{{ route('admin.souvenir.view', ['sort' => 'alphabetical']) }}"
                                    class="block px-3 py-2 text-sm text-gray-700 hover:bg-cream rounded-md">Alphabetical</a>
                                <a href="{{ route('admin.souvenir.view', ['sort' => 'order']) }}"
                                    class="block px-3 py-2 text-sm text-gray-700 hover:bg-cream rounded-md">Tanggal
                                    Order</a>
                                <a href="{{ route('admin.souvenir.view', ['sort' => 'deadline']) }}"
                                    class="block px-3 py-2 text-sm text-gray-700 hover:bg-cream rounded-md">Tanggal
                                    Deadline</a>
                            </div>
                        </div>
                                    ...
                                    <tbody class="bg-green-main/10">
                                        @foreach ($souvenir as $o)
                                            ...
                                            {{ stripos($o->user_name, 'shopee') !== false ? 'bg-brown-enzo text-white' : 'bg-green-main/0' }}"
                                                    ...
                                                    <td class="px-3 py-3 text-center">
                                                        <form
                                                            action="{{ route('admin.souvenir.update_payment_subprocess') }}"
                                                            method="POST">
                                                            @csrf
                                                    ...
                                                    <td class="px-3 py-3 text-center">
                                                        <form
                                                            action="{{ route('admin.souvenir.detail', ['id' => $o->id]) }}"
                                        ...
                                        @foreach ($souvenir as $o)
                                            ...
                                            {{ stripos($o->user_name, 'shopee') !== false ? 'bg-brown-enzo text-white' : 'bg-green-main/0' }}">
                                                    ...
                                                    <td class="px-3 py-3 text-center">
                                                        {{ \Carbon\Carbon::parse($o->event_date)->format('d/m/Y') }}</td>
                                                    <td class="px-3 py-3 text-center">
                                                        {{ \Carbon\Carbon::parse($o->deadline_date)->format('d/m/Y') }}
                                                    </td>
                                                    <td class="px-3 py-3 text-center hover:cursor-pointer"
                                                        onclick="showModal('note_design', '{{ $o->note_design }}')">
                                                    ...
                                                    <td class="px-3 py-3 text-center">
                                                        <form
                                                            ...
                                                            <select name="subprocess"
                                                                class="bg-green-light border border-gray-300 rounded-md px-2 py-1"
                                                                onchange="this.form.submit()">
                                                                <option value="Antri Potong Kain"
                                                                    {{ old('subprocess', $o->subprocess) == 'Antri Potong Kain' ? 'selected' : '' }}>
                                                                    Antri Potong Kain</option>
                                                                <option value="Potong Kain"
                                                                    {{ old('subprocess', $o->subprocess) == 'Potong Kain' ? 'selected' : '' }}>
                                                                    Potong Kain</option>
                                                                <option value="Emboss/Label"
                                                                    {{ old('subprocess', $o->subprocess) == 'Emboss/Label' ? 'selected' : '' }}>
                                                                    Emboss/Label</option>
                                                                <option value="Sablon/Decal"
                                                                    {{ old('subprocess', $o->subprocess) == 'Sablon/Decal' ? 'selected' : '' }}>
                                                                    Sablon/Decal</option>
                                                                <option value="Antri Jahit"
                                                                    {{ old('subprocess', $o->subprocess) == 'Antri Jahit' ? 'selected' : '' }}>
                                                                    Antri Jahit</option>
                                                                <option value="Jahit"
                                                                    {{ old('subprocess', $o->subprocess) == 'Jahit' ? 'selected' : '' }}>
                                                                    Jahit</option>
                                                                <option value="Antri Kemas"
                                                                    {{ old('subprocess', $o->subprocess) == 'Antri Kemas' ? 'selected' : '' }}>
                                                                    Antri Kemas</option>
                                                                <option value="Kemas"
                                                                    {{ old('subprocess', $o->subprocess) == 'Kemas' ? 'selected' : '' }}>
                                                                    Kemas</option>
                                                            </select>
                                                        </form>
                                                    </td>
                                        ...
                                        @foreach ($souvenir as $o)
                                            ...
                                            {{ stripos($o->user_name, 'shopee') !== false ? 'bg-brown-enzo text-white' : 'bg-green-main/0' }}">
                                                    ...
                                                    <td class="px-3 py-3 text-center">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.order.delete', ['id' => $o->id]) }}"
                                                            method="POST" onsubmit="return confirmDelete(event)"
                                                            class="inline-block">
                                                            @csrf
                                                            @method('POST')
