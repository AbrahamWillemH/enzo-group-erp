                ...
                <section id="pending" class="pending mb-20">
                    ...
                    <div class="px-3 w-[1010px] 2xl:w-[1200px] mx-auto">
                        <div class="data mt-[6.75rem] mb-5 gap-0 relative overflow-x-auto rounded-lg max-h-[480px]">
                            <table class="w-[1550px] 2xl:w-[1650px] border capitalize shadow-inner z-10">
                                ...
                                <tbody class="bg-green-main/10">
                                    @foreach ($invitation as $o)
                                        ...
                                        {{ stripos($o->user_name, 'shopee') !== false ? 'bg-brown-enzo text-white' : 'bg-green-main/0' }}"
                                                ...
                                                <td class="px-3 py-3 text-center">
                                                    <form
                                                        action="{{ route('admin.invitation.update_payment_subprocess') }}"
                                                        method="POST">
                                                        @csrf
                                                ...
                                                <td class="px-3 py-3 text-center">
                                                    <form
                                                        action="{{ route('admin.invitation.detail', ['id' => $o->id]) }}"
                                                    ...
                                                    <form
                                                        ...
                                                        <select name="subprocess"
                                                            ...
                                                            <option value="Laminasi"
                                                                ...
                                                                Laminasi</option>
                                                            <option value="Antri Potong Kertas/Pond"
                                                                {{ old('subprocess', $o->subprocess) == 'Antri Potong Kertas/Pond' ? 'selected' : '' }}>
                                                                Antri Potong Kertas/Pond</option>
                                                            <option value="Potong Kertas/Pond"
                                                                {{ old('subprocess', $o->subprocess) == 'Potong Kertas/Pond' ? 'selected' : '' }}>
                                                                Potong Kertas/Pond</option>
                                                            <option value="Antri Foil"
                                                                {{ old('subprocess', $o->subprocess) == 'Antri Foil' ? 'selected' : '' }}>
                                                                Antri Foil</option>
                                                            <option value="Foil"
                                                                {{ old('subprocess', $o->subprocess) == 'Foil' ? 'selected' : '' }}>
                                                                Foil</option>
                                                            <option value="Antri Lem"
                                                                {{ old('subprocess', $o->subprocess) == 'Antri Lem' ? 'selected' : '' }}>
                                                                Antri Lem</option>
                                                            <option value="Lem"
                                                                {{ old('subprocess', $o->subprocess) == 'Lem' ? 'selected' : '' }}>
                                                                Lem</option>
                                                            <option value="Antri Lipat"
                                                                {{ old('subprocess', $o->subprocess) == 'Antri Lipat' ? 'selected' : '' }}>
                                                                Antri Lipat</option>
                                                            <option value="Lipat"
                                                                {{ old('subprocess', $o->subprocess) == 'Lipat' ? 'selected' : '' }}>
                                                                Lipat</option>
                                                            <option value="Proses Amplop"
                                                                {{ old('subprocess', $o->subprocess) == 'Proses Amplop' ? 'selected' : '' }}>
                                                                Proses Amplop</option>
                                                            <option value="Pasang Gunungan/Ornamen"
                                                                {{ old('subprocess', $o->subprocess) == 'Pasang Gunungan/Ornamen' ? 'selected' : '' }}>
                                                                Pasang Gunungan/Ornamen</option>
                                                            <option value="Menunggu Kartu/Label"
                                                                {{ old('subprocess', $o->subprocess) == 'Menunggu Kartu/Label' ? 'selected' : '' }}>
                                                                Menunggu Kartu/Label</option>
                                                        </select>
                                                    </form>
                                                <td class="px-3 py-3 text-center">
                                                    <form
