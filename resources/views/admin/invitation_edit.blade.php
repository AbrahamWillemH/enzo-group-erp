...
<body class="bg-[#fcfffa] font-mont">
    <!-- Navigation Bar -->
    <nav
        class="fixed w-full flex justify-between items-center px-4 sm:px-6 py-4 bg-green-main text-brown-enzo shadow-md z-50">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center min-h-screen justify-start py-24 text-green-main font-sans"
        style="letter-spacing: 3px">
        <h2 class="text-lg sm:text-xl md:text-2xl tracking-widest font-medium">EDIT INVITATION :
            {{ $invitation->user_name }}</h2>
        ...
        <form action="{{ route('admin.invitation.update', ['id' => $invitation->id]) }}" method="POST"
            class="flex flex-col gap-5 items-center" enctype="multipart/form-data">
            @csrf

            <!-- Customer Info -->
            <div
                class="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12 lg:gap-40 justify-center w-full max-w-5xl mx-auto px-4">
                <div class="flex flex-col gap-5">

                    <div class="flex items-center flex-col">
                        <label for="user_name">Nama Pemesan</label>
                        <input type="text" id="user_name" name="user_name" value="{{ $invitation->user_name }}"
                            required placeholder="Nama Pemesan"
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <input type="text" id="phone_number" name="phone_number"
                            value="{{ $invitation->phone_number }}" required placeholder="08XX-XXXX-XXXX"
                            class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        @error('phone_number')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <input type="text" id="instagram" name="instagram" value="{{ $invitation->instagram }}"
                            required placeholder="Akun Instagram"
                            class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        @error('instagram')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <textarea id="address" rows="7" name="address" required placeholder="Alamat Lengkap"
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <input type="number" id="quantity" name="quantity" value="{{ $invitation->quantity }}"
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <input product_name="text" id="product_name" name="product_name"
                            value="{{ $invitation->product_name }}" required placeholder="Tipe Produk"
                            class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        @error('product_name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <input type="text" id="finishing" name="finishing" value="{{ $invitation->finishing }}"
                            required placeholder="Finishing"
                            class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        @error('finishing')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <select
                            class="form-control outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-1 sm:py-1 md:py-1 lg:py-1"
                            id="source" name="source"required>
                            <option value="Shopee"
                                {{ old('source', $invitation->source) == 'Shopee' ? 'selected' : '' }}>Shopee</option>
                            <option value="Deonkraft"
                                {{ old('source', $invitation->source) == 'Deonkraft' ? 'selected' : '' }}>Deonkraft
                            </option>
                            <option value="Enzo Wedding"
                                {{ old('source', $invitation->source) == 'Enzo Wedding' ? 'selected' : '' }}>Enzo
                                Wedding</option>
                            <option value="Grizelle"
                                {{ old('source', $invitation->source) == 'Grizelle' ? 'selected' : '' }}>Grizelle
                            </option>
                        </select>
                        @error('kemas')
                            <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="flex items-center flex-col">
                        ...
                        <textarea id="note_design" rows="4" name="note_design" placeholder="Tulis catatan tambahan disini"
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="groom_name" name="groom_name"
                                value="{{ $invitation->groom_name }}" required placeholder="Nama Lengkap"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('groom_name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="groom_nickname" name="groom_nickname"
                                value="{{ $invitation->groom_nickname }}" required placeholder="Nama Panggilan"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="groom_father" name="groom_father"
                                value="{{ $invitation->groom_father }}" required placeholder="Nama Lengkap Ayah"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('groom_father')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="groom_mother" name="groom_mother"
                                value="{{ $invitation->groom_mother }}" required placeholder="Nama Lengkap Ibu"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('groom_mother')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="bride_name" name="bride_name"
                                value="{{ $invitation->bride_name }}" required placeholder="Nama Lengkap"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('bride_name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="bride_nickname" name="bride_nickname"
                                value="{{ $invitation->bride_nickname }}" required placeholder="Nama Panggilan"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="bride_father" name="bride_father"
                                value="{{ $invitation->bride_father }}" required placeholder="Nama Lengkap Ayah"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('bride_father')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="bride_mother" name="bride_mother"
                                value="{{ $invitation->bride_mother }}" required placeholder="Nama Lengkap Ibu"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('bride_mother')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center flex-col">
                            ...
                            <input type="date" id="akad_pemberkatan_date" name="akad_pemberkatan_date"
                                value="{{ $invitation->akad_pemberkatan_date }}" required
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select name="time_zone" id="time_zone"
                                    ...
                                    <option value="WIB" {{ $invitation->time_zone == 'WIB' ? 'selected' : '' }}>WIB
                                    </option>
                                    <option value="WITA" {{ $invitation->time_zone == 'WITA' ? 'selected' : '' }}>
                                        WITA</option>
                                    <option value="WIT" {{ $invitation->time_zone == 'WIT' ? 'selected' : '' }}>WIT
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="relative w-70">
                                    <input type="text" id="timePicker" name="akad_pemberkatan_time_done"
                                        value="{{ $invitation->akad_pemberkatan_time_done }}" required
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center flex-col">
                            ...
                            <input type="date" id="reception_date" name="reception_date"
                                value="{{ $invitation->reception_date }}" required
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <textarea id="reception_location" rows="5" name="reception_location" required placeholder="Lokasi Resepsi"
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="file" id="desain_path" name="desain_path" accept=".jpg,.jpeg,.png,.pdf"
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <select id="progress" name="progress"
                                ...
                                <option value="Pending"
                                    {{ old('progress', $invitation->progress) == 'Pending' ? 'selected' : '' }}>
                                    Menunggu Pembayaran dan Desain</option>
                                <option value="Fix"
                                    {{ old('progress', $invitation->progress) == 'Fix' ? 'selected' : '' }}>Menentukan
                                    Deadline</option>
                                <option value="Pemesanan Bahan"
                                    {{ old('progress', $invitation->progress) == 'Pemesanan Bahan' ? 'selected' : '' }}>
                                    Pemesanan Bahan</option>
                                <option value="Proses Produksi"
                                    {{ old('progress', $invitation->progress) == 'Proses Produksi' ? 'selected' : '' }}>
                                    Proses Produksi</option>
                                <option value="Selesai"
                                    {{ old('progress', $invitation->progress) == 'Selesai' ? 'selected' : '' }}>
                                    Menunggu Ambil / Kirim</option>
                                <option value="Selesai Beneran"
                                    {{ old('progress', $invitation->progress) == 'Selesai Beneran' ? 'selected' : '' }}>
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <select id="payment_status" name="payment_status"
                                ...
                                required>
                                <option value="Pending"
                                    {{ old('payment_status', $invitation->payment_status) == 'Pending' ? 'selected' : '' }}>
                                    Pending</option>
                                <option value="DP 1"
                                    {{ old('payment_status', $invitation->payment_status) == 'DP 1' ? 'selected' : '' }}>
                                    DP 1</option>
                                <option value="DP 2"
                                    {{ old('payment_status', $invitation->payment_status) == 'DP 2' ? 'selected' : '' }}>
                                    DP 2</option>
                                <option value="Lunas"
                                    {{ old('payment_status', $invitation->payment_status) == 'Lunas' ? 'selected' : '' }}>
                                    Lunas</option>
                            </select>
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="date" id="dp1_date" name="dp1_date"
                                value="{{ $invitation->dp1_date }}"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('dp1_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="date" id="dp2_date" name="dp2_date"
                                value="{{ $invitation->dp2_date }}"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('dp2_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="date" id="paid_off_date" name="paid_off_date"
                                value="{{ $invitation->paid_off_date }}"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('paid_off_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col ">
                            ...
                            <input type="date" id="fix_design_date" name="fix_design_date"
                                value="{{ $invitation->fix_design_date }}"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                        ...
                        <div class="flex items-center flex-col ">
                            ...
                            <input type="date" id="deadline_date" name="deadline_date"
                                value="{{ $invitation->deadline_date }}"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('deadline_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center flex-col">
                            ...
                            <div class="relative w-full">
                                <span
                                    class="absolute left-2 top-[13px] transform -translate-y-1/2 text-gray-600">Rp</span>
                                ...
                                <input type="hidden" id="price_per_pcs_hidden" name="price_per_pcs"
                                    value="{{ $invitation->price_per_pcs }}">
                            </div>
                            @error('price_per_pcs')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="printout" name="printout"
                                value="{{ $invitation->printout }}" placeholder="Percetakan"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('printout')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="expedition" name="expedition"
                                value="{{ $invitation->expedition }}" placeholder="Ekspedisi"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('expedition')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <select id="design_status" name="design_status"
                                ...
                                required>
                                <option value="Pending"
                                    {{ old('design_status', $invitation->design_status) == 'Pending' ? 'selected' : '' }}>
                                    Pending</option>
                                <option value="ACC"
                                    {{ old('design_status', $invitation->design_status) == 'ACC' ? 'selected' : '' }}>
                                    ACC</option>
                                <option value="DECL"
                                    {{ old('design_status', $invitation->design_status) == 'DECL' ? 'selected' : '' }}>
                                    DECL</option>
                            </select>
                            @error('design_status')
                                <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <input type="text" id="size_fix" name="size_fix"
                                value="{{ $invitation->size_fix }}" placeholder="Ukuran Jadi"
                                class="outline-none border border-[#e0e0e0] bg-[#f0f0f0] w-full rounded-xl px-2 py-0.5 sm:py-0.5 md:py-0.5 lg:py-0.5">
                            @error('size_fix')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="flex items-center flex-col">
                            ...
                            <textarea id="note_cs" rows="6" name="note_cs" placeholder="Tulis catatan tambahan disini"
