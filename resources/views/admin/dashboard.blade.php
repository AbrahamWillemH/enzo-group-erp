  ...
  <div class="ml-[20%] bg-green-light">
    ...
    <div class="container h-screen">
      <div class="h-screen grid grid-rows-[8%_92%]">
        <div class="m-auto p-1">
          <div class="flex flex-row justify-start items-center rounded-lg w-[1000px] h-[45px] p-2">
            ...
            <p class="font-quattro text-xl lg:text-xl font-bold text-green-main">Hello, {{ auth()->user()->name }}</p>
          </div>
        </div>
