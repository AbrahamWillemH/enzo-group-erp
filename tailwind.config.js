    ...
    theme: {
        extend: {
            ...
            keyframes: {
                ...
                rotateContainers1Mobile: {
                    '0%': { transform: 'translateX(0)',width: '105px', height:'140px', zIndex: 5 },
                    '33.33%': { transform: 'translateX(241.5px)',width: '105px', height:'140px', zIndex: 5 },
                    '66.66%': { transform: 'translateX(104.5px)', width: '140px', height:'187px', zIndex: 10 },
                    '100%': { transform: 'translateX(0)',width: '105px', height:'140px', zIndex: 5 },
                },
                rotateContainers2Mobile: {
                    '0%': { transform: 'translateX(0)',width: '140px', height:'187px', zIndex: 10 },
                    '33.33%': { transform: 'translateX(-104.5px)',width: '105px', height:'140px', zIndex: 5 },
                    '66.66%': { transform: 'translateX(104.5px)',width: '105px', height:'140px', zIndex: 5 },
                    '100%': { transform: 'translateX(0)',width: '140px', height:'187px', zIndex: 10 },
                },
                rotateContainers3Mobile: {
                    '0%': { transform: 'translateX(0)',width: '105px', height:'140px', zIndex: 5 },
                    '33.33%': { transform: 'translateX(-102.5px)',width: '140px', height:'187px', zIndex: 10 },
                    '66.66%': { transform: 'translateX(-241.5px)', width: '105px', height:'140px', zIndex: 5 },
                    '100%': { transform: 'translateX(0)',width: '105px', height:'140px', zIndex: 5 },
                },
              },
              animation: {
                ...
                rotateContainers1Mobile: 'rotateContainers1Mobile 12s ease-in-out infinite',
                rotateContainers2Mobile: 'rotateContainers2Mobile 12s ease-in-out infinite',
                rotateContainers3Mobile: 'rotateContainers3Mobile 12s ease-in-out infinite',
              },
        },
    },
    plugins: [],
